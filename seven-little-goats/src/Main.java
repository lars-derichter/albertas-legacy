...
class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("verhalen het niet over eens: de een zweert bij de schaar");
        System.out.println("en de stenen, de ander bij een kille afrekening, een");
        ...
        System.out.println("open. Zes gingen naar binnen — in de wolf.");
        System.out.println();
        System.out.println("Het jongste kroop in de klokkast en overleefde. Het ging");
        System.out.println("niet naar de dorpelingen (die vonden alles \"te");
        System.out.println("gevaarlijk\", zoals altijd), maar naar de enige met");
        System.out.println("verstand van wolven: naar jou.");
        System.out.println();
